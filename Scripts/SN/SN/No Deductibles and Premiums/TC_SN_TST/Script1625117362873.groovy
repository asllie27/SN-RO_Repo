...
WebUI.callTestCase(findTestCase('Login/OSN Login/Login SN_TST'), [:], FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'myKeyword.PolicyNumber_Happy_SN.getALPolicyNumber'(AL_PolicyNumber)
...
WebUI.setText(findTestObject('Auto Liability/03Vehicle/input_Vehicle VIN'), VIN_2)
...
WebUI.selectOptionByValue(findTestObject('Auto Liability/03Vehicle/select_VIN_States'), VIN_State_2, false)
...
WebUI.setText(findTestObject('Auto Liability/03Vehicle/input_Vehicle VIN'), VIN_3)
...
WebUI.selectOptionByValue(findTestObject('Auto Liability/03Vehicle/select_VIN_States'), VIN_State_3, false)
...
CustomKeywords.'myKeyword.PolicyNumber_Happy_SN.getAPDPolicyNumber'(APD_PolicyNumber)
