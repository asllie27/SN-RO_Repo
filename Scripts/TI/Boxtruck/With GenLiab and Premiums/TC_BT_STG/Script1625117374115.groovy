...
WebUI.callTestCase(findTestCase('Login/RO Login/Login BT_STG'), [:], FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'myKeyword.PolicyNumber_Happy_BT.getALPolicyNumber'(AL_PolicyNumber)
...
WebUI.setText(findTestObject('Auto Liability/06Premium and Limits/input_Premium Limits MedPayments Per Person'), MedPay_Per_Person)
...
WebUI.setText(findTestObject('Auto Liability/07Finance/02Non Premium/input_Non-Premium and Premium Amount'), General_Liability)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Deductible'), GenLiab_Deductible)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Each Occurence Limit'), 
    GenLiab_Each_Occurence_Limit)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Personal Advertising Limit'), 
    GenLiab_Personal_Advertising_Limit)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Medical Expense'), GenLiab_Medical_Expense)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Damages to Premises Rented to You'), 
    GenLiab_Damages_toPremises)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Products or Completed Operations'), 
    GenLiab_Product_orCompleted_Operations)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_General Aggregate Limit'), 
    GenLiab_General_Aggregate_Limit)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Comments'), 'This is a comment')
...
WebUI.setText(findTestObject('Auto Liability/07Finance/02Non Premium/input_Non-Premium and Premium Amount'), Motor_Truck_Cargo)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Limit'), MTCargo_Limit)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Deductible'), MTCargo_Deductible)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Comments'), 'This is a comment on Motor Truck')
...
CustomKeywords.'myKeyword.PolicyNumber_Happy_BT.getAPDPolicyNumber'(APD_PolicyNumber)
...
WebUI.setText(findTestObject('Auto Liability/07Finance/02Non Premium/input_Non-Premium and Premium Amount'), APD_General_Liability)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Deductible'), APD_GenLiab_Deductible)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Each Occurence Limit'), 
    APD_GenLiab_Each_Occurence_Limit)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Personal Advertising Limit'), 
    APD_GenLiab_Personal_Advertising_Limit)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Medical Expense'), APD_GenLiab_Medical_Expense)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Damages to Premises Rented to You'), 
    APD_GenLiab_Damages_toPremises)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Products or Completed Operations'), 
    APD_GenLiab_Product_orCompleted_Operations)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_General Aggregate Limit'), 
    APD_GenLiab_General_Aggregate_Limit)
...
WebUI.setText(findTestObject('Auto Liability/07Finance/02Non Premium/input_Non-Premium and Premium Amount'), APD_Motor_Truck_Cargo)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Limit'), APD_MTCargo_Limit)

WebUI.setText(findTestObject('Auto Liability/07Finance/03Additional Premium/General Liability/input_Deductible'), APD_MTCargo_Deductible)
